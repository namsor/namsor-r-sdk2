...
#' @field personalNames  list( \link{ParsedFullNameGeoIn} ) [optional]
#'
#'
  ...
  public = list(
    ...
    fromJSON = function(BatchParsedFullNameGeoInJson) {
      ...
      if (!is.null(BatchParsedFullNameGeoInObject$`personalNames`)) {
        self$`personalNames` <- ApiClient$new()$deserializeObj(BatchParsedFullNameGeoInObject$`personalNames`, "array[ParsedFullNameGeoIn]", loadNamespace("namsor"))
      }
    },

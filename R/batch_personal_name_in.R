...
#' @docType class
#' @title BatchPersonalNameIn
#' @description BatchPersonalNameIn Class
#' @format An \code{R6Class} generator object
#' @field personalNames  list( \link{PersonalNameIn} ) [optional]
#'
#'
  ...
  public = list(
    ...
    fromJSON = function(BatchPersonalNameInJson) {
      ...
      if (!is.null(BatchPersonalNameInObject$`personalNames`)) {
        self$`personalNames` <- ApiClient$new()$deserializeObj(BatchPersonalNameInObject$`personalNames`, "array[PersonalNameIn]", loadNamespace("namsor"))
      }
    },

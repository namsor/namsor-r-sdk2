  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`personalNames`)) {
        BatchFirstLastNameInObject[['personalNames']] <- lapply(self$`personalNames`, function(x) x$toJSON())
      }
    ...
    fromJSON = function(BatchFirstLastNameInJson) {
      ...
      if (!is.null(BatchFirstLastNameInObject$`personalNames`)) {
        self$`personalNames` <- lapply(BatchFirstLastNameInObject$`personalNames`, function(x) {
    ...
    fromJSONString = function(BatchFirstLastNameInJson) {
      BatchFirstLastNameInObject <- jsonlite::fromJSON(BatchFirstLastNameInJson)
      self$`personalNames` <- lapply(BatchFirstLastNameInObject$`personalNames`, function(x) FirstLastNameIn$new()$fromJSON(jsonlite::toJSON(x, auto_unbox = TRUE)))
    }
  )
)

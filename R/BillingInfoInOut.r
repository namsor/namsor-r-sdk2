  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`billingEmail`)) {
        BillingInfoInOutObject[['billingEmail']] <- self$`billingEmail`
      }
      if (!is.null(self$`preferredCurrency`)) {
        BillingInfoInOutObject[['preferredCurrency']] <- self$`preferredCurrency`
      }
      if (!is.null(self$`customerName`)) {
        BillingInfoInOutObject[['customerName']] <- self$`customerName`
      }
      if (!is.null(self$`customerPhone`)) {
        BillingInfoInOutObject[['customerPhone']] <- self$`customerPhone`
      }
      if (!is.null(self$`addressLine1`)) {
        BillingInfoInOutObject[['addressLine1']] <- self$`addressLine1`
      }
      if (!is.null(self$`addressLine2`)) {
        BillingInfoInOutObject[['addressLine2']] <- self$`addressLine2`
      }
      if (!is.null(self$`addressCity`)) {
        BillingInfoInOutObject[['addressCity']] <- self$`addressCity`
      }
      if (!is.null(self$`addressPostalCode`)) {
        BillingInfoInOutObject[['addressPostalCode']] <- self$`addressPostalCode`
      }
      if (!is.null(self$`addressState`)) {
        BillingInfoInOutObject[['addressState']] <- self$`addressState`
      }
      if (!is.null(self$`addressCountry`)) {
        BillingInfoInOutObject[['addressCountry']] <- self$`addressCountry`
      }
      if (!is.null(self$`vatID`)) {
        BillingInfoInOutObject[['vatID']] <- self$`vatID`
      }

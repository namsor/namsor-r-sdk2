  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`subscription`)) {
        APIPeriodUsageOutObject[['subscription']] <- self$`subscription`$toJSON()
      }
      if (!is.null(self$`billingPeriod`)) {
        APIPeriodUsageOutObject[['billingPeriod']] <- self$`billingPeriod`$toJSON()
      }
      if (!is.null(self$`overageExclTax`)) {
        APIPeriodUsageOutObject[['overageExclTax']] <- self$`overageExclTax`
      }
      if (!is.null(self$`overageInclTax`)) {
        APIPeriodUsageOutObject[['overageInclTax']] <- self$`overageInclTax`
      }
      if (!is.null(self$`overageCurrency`)) {
        APIPeriodUsageOutObject[['overageCurrency']] <- self$`overageCurrency`
      }
      if (!is.null(self$`overageQuantity`)) {
        APIPeriodUsageOutObject[['overageQuantity']] <- self$`overageQuantity`
      }
    ...
    fromJSONString = function(APIPeriodUsageOutJson) {
      APIPeriodUsageOutObject <- jsonlite::fromJSON(APIPeriodUsageOutJson)
      APIPlanSubscriptionOutObject <- APIPlanSubscriptionOut$new()
      self$`subscription` <- APIPlanSubscriptionOutObject$fromJSON(jsonlite::toJSON(APIPeriodUsageOutObject$subscription, auto_unbox = TRUE))
      APIBillingPeriodUsageOutObject <- APIBillingPeriodUsageOut$new()
      self$`billingPeriod` <- APIBillingPeriodUsageOutObject$fromJSON(jsonlite::toJSON(APIPeriodUsageOutObject$billingPeriod, auto_unbox = TRUE))
      self$`overageExclTax` <- APIPeriodUsageOutObject$`overageExclTax`
      self$`overageInclTax` <- APIPeriodUsageOutObject$`overageInclTax`
      self$`overageCurrency` <- APIPeriodUsageOutObject$`overageCurrency`
      self$`overageQuantity` <- APIPeriodUsageOutObject$`overageQuantity`

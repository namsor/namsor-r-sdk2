...
#' @field classifierMetrics   \link[namsor:ClassifierMetricsOut]{   list(ClassifierMetricsOut)   }  [optional]
#'
#' @field sourceMetrics   \link[namsor:SourceMetricsOut]{   list(SourceMetricsOut)   }  [optional]
#'

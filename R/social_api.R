...
#' @section Methods:
#' \describe{
#' \strong{ PhoneCode } \emph{ [USES 11 UNITS] Infer the likely country and phone prefix, given a personal name and formatted / unformatted phone number. }
#' 
#'
#' \itemize{
...
#' \item \emph{ @returnType } \link[namsor:FirstLastNamePhoneCodedOut]{ FirstLastNamePhoneCodedOut }   \cr
#'
#'
...
#' }
#'
#' \strong{ PhoneCodeBatch } \emph{ [USES 11 UNITS] Infer the likely country and phone prefix, of up to 100 personal names, detecting automatically the local context given a name and formatted / unformatted phone number. }
#' 
#'
#' \itemize{
#' \item \emph{ @param } batch.first.last.name.phone.number.in \link[namsor:BatchFirstLastNamePhoneNumberIn]{ BatchFirstLastNamePhoneNumberIn }
#' \item \emph{ @returnType } \link[namsor:BatchFirstLastNamePhoneCodedOut]{ BatchFirstLastNamePhoneCodedOut }   \cr
#'
#'
...
#' }
#'
#' \strong{ PhoneCodeGeo } \emph{ [USES 11 UNITS] Infer the likely phone prefix, given a personal name and formatted / unformatted phone number, with a local context (ISO2 country of residence). }
#' 
#'
#' \itemize{
#' \item \emph{ @param } first.name character
...
#' }
#'
#' \strong{ PhoneCodeGeoBatch } \emph{ [USES 11 UNITS] Infer the likely country and phone prefix, of up to 100 personal names, with a local context (ISO2 country of residence). }
#' 
#'
#' \itemize{
#' \item \emph{ @param } batch.first.last.name.phone.number.geo.in \link[namsor:BatchFirstLastNamePhoneNumberGeoIn]{ BatchFirstLastNamePhoneNumberGeoIn }
#' \item \emph{ @returnType } \link[namsor:BatchFirstLastNamePhoneCodedOut]{ BatchFirstLastNamePhoneCodedOut }   \cr
#'
#'
#' \item status code : 200 | A list of genderized names.
...
SocialApi <- R6::R6Class(
  ...
  public = list(
    ...
    PhoneCodeWithHttpInfo = function(first.name, last.name, phone.number, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "FirstLastNamePhoneCodedOut", "package:namsor"),
          error = function(e){
    ...
    PhoneCodeBatchWithHttpInfo = function(batch.first.last.name.phone.number.in=NULL, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "BatchFirstLastNamePhoneCodedOut", "package:namsor"),
          error = function(e){
             stop("Failed to deserialize response")
          }
        )

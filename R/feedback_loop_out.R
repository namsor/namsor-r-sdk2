...
#' @docType class
#' @title FeedbackLoopOut
#' @description FeedbackLoopOut Class
#' @format An \code{R6Class} generator object
#' @field feedbackCredits   integer  [optional]
#'
#'
...
FeedbackLoopOut <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`feedbackCredits`=NULL, ...){
      local.optional.var <- list(...)
      if (!is.null(`feedbackCredits`)) {
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`feedbackCredits`)) {
        FeedbackLoopOutObject[['feedbackCredits']] <-

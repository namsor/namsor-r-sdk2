...
#' @field subscription   \link[namsor:APIPlanSubscriptionOut]{  APIPlanSubscriptionOut  }  [optional]
#'
#' @field billingPeriod   \link[namsor:APIBillingPeriodUsageOut]{  APIBillingPeriodUsageOut  }  [optional]
#'

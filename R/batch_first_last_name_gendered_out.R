...
#' @field personalNames  list( \link{FirstLastNameGenderedOut} ) [optional]
#'
#'
  ...
  public = list(
    ...
    fromJSON = function(BatchFirstLastNameGenderedOutJson) {
      ...
      if (!is.null(BatchFirstLastNameGenderedOutObject$`personalNames`)) {
        self$`personalNames` <- ApiClient$new()$deserializeObj(BatchFirstLastNameGenderedOutObject$`personalNames`, "array[FirstLastNameGenderedOut]", loadNamespace("namsor"))
      }
    },

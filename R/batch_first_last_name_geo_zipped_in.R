...
#' @docType class
#' @title BatchFirstLastNameGeoZippedIn
#' @description BatchFirstLastNameGeoZippedIn Class
#' @format An \code{R6Class} generator object
#' @field personalNames  list( \link{FirstLastNameGeoZippedIn} ) [optional]
#'
#'
  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`personalNames`)) {
        BatchFirstLastNameGeoZippedInObject[['personalNames']] <-
    ...
    fromJSON = function(BatchFirstLastNameGeoZippedInJson) {
      ...
      if (!is.null(BatchFirstLastNameGeoZippedInObject$`personalNames`)) {
        self$`personalNames` <- ApiClient$new()$deserializeObj(BatchFirstLastNameGeoZippedInObject$`personalNames`, "array[FirstLastNameGeoZippedIn]", loadNamespace("namsor"))
      }
    },

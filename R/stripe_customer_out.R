...
#'
#' @field stripedCards  list( \link{StripeCardOut} ) [optional]
#'
#'
  ...
  public = list(
    ...
    fromJSON = function(StripeCustomerOutJson) {
      ...
      if (!is.null(StripeCustomerOutObject$`stripedCards`)) {
        self$`stripedCards` <- ApiClient$new()$deserializeObj(StripeCustomerOutObject$`stripedCards`, "array[StripeCardOut]", loadNamespace("namsor"))
      }
    },

...
#' @docType class
#' @title BatchFirstLastNameGenderIn
#' @description BatchFirstLastNameGenderIn Class
#' @format An \code{R6Class} generator object
#' @field personalNames  list( \link{FirstLastNameGenderIn} ) [optional]
#'
#'
  ...
  public = list(
    ...
    fromJSON = function(BatchFirstLastNameGenderInJson) {
      ...
      if (!is.null(BatchFirstLastNameGenderInObject$`personalNames`)) {
        self$`personalNames` <- ApiClient$new()$deserializeObj(BatchFirstLastNameGenderInObject$`personalNames`, "array[FirstLastNameGenderIn]", loadNamespace("namsor"))
      }
    },

...
FirstLastNamePhoneNumberIn <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`id`, `firstName`, `lastName`, `phoneNumber`, `FirstLastNameOriginedOut`){
      if (!missing(`id`)) {
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`id`)) {
        FirstLastNamePhoneNumberInObject[['id']] <- self$`id`
      }
      if (!is.null(self$`firstName`)) {
        FirstLastNamePhoneNumberInObject[['firstName']] <- self$`firstName`
      }
      if (!is.null(self$`lastName`)) {
        FirstLastNamePhoneNumberInObject[['lastName']] <- self$`lastName`
      }
      if (!is.null(self$`phoneNumber`)) {
        FirstLastNamePhoneNumberInObject[['phoneNumber']] <- self$`phoneNumber`
      }
      if (!is.null(self$`FirstLastNameOriginedOut`)) {
        FirstLastNamePhoneNumberInObject[['FirstLastNameOriginedOut']] <- self$`FirstLastNameOriginedOut`$toJSON()
      }
    ...
    fromJSONString = function(FirstLastNamePhoneNumberInJson) {
      ...
      self$`phoneNumber` <- FirstLastNamePhoneNumberInObject$`phoneNumber`
      FirstLastNameOriginedOutObject <- FirstLastNameOriginedOut$new()
      self$`FirstLastNameOriginedOut` <- FirstLastNameOriginedOutObject$fromJSON(jsonlite::toJSON(FirstLastNamePhoneNumberInObject$FirstLastNameOriginedOut, auto_unbox = TRUE))
    }
  )
)

...
#' @field personalNames  list( \link{FirstLastNameDiasporaedOut} ) [optional]
#'
#'
  ...
  public = list(
    ...
    fromJSON = function(BatchFirstLastNameDiasporaedOutJson) {
      ...
      if (!is.null(BatchFirstLastNameDiasporaedOutObject$`personalNames`)) {
        self$`personalNames` <- ApiClient$new()$deserializeObj(BatchFirstLastNameDiasporaedOutObject$`personalNames`, "array[FirstLastNameDiasporaedOut]", loadNamespace("namsor"))
      }
    },

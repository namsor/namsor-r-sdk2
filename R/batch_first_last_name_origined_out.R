...
#' @docType class
#' @title BatchFirstLastNameOriginedOut
#' @description BatchFirstLastNameOriginedOut Class
#' @format An \code{R6Class} generator object
#' @field personalNames   \link[namsor:FirstLastNameOriginedOut]{   list(FirstLastNameOriginedOut)   }  [optional]
#'
#'
  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`personalNames`)) {
        BatchFirstLastNameOriginedOutObject[['personalNames']] <-
    ...
    fromJSON = function(BatchFirstLastNameOriginedOutJson) {
      ...
      if (!is.null(BatchFirstLastNameOriginedOutObject$`personalNames`)) {
        self$`personalNames` <- ApiClient$new()$deserializeObj(BatchFirstLastNameOriginedOutObject$`personalNames`, "array[FirstLastNameOriginedOut]", "package:namsor")
      }
    },

...
#' @field personalNames  list( \link{FirstLastNameOriginedOut} ) [optional]
#'
#'
  ...
  public = list(
    ...
    fromJSON = function(BatchFirstLastNameOriginedOutJson) {
      ...
      if (!is.null(BatchFirstLastNameOriginedOutObject$`personalNames`)) {
        self$`personalNames` <- ApiClient$new()$deserializeObj(BatchFirstLastNameOriginedOutObject$`personalNames`, "array[FirstLastNameOriginedOut]", loadNamespace("namsor"))
      }
    },

...
#' @field stripeInvoices  list( \link{InvoiceOut} ) [optional]
#'
#' @field corporateInvoices  list( \link{InvoiceOut} ) [optional]
#'
#'
  ...
  public = list(
    ...
    fromJSON = function(BillingHistoryOutJson) {
      ...
      if (!is.null(BillingHistoryOutObject$`stripeInvoices`)) {
        self$`stripeInvoices` <- ApiClient$new()$deserializeObj(BillingHistoryOutObject$`stripeInvoices`, "array[InvoiceOut]", loadNamespace("namsor"))
      }
      if (!is.null(BillingHistoryOutObject$`corporateInvoices`)) {
        self$`corporateInvoices` <- ApiClient$new()$deserializeObj(BillingHistoryOutObject$`corporateInvoices`, "array[InvoiceOut]", loadNamespace("namsor"))
      }
    },

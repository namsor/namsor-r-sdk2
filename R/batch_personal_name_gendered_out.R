...
#' @field personalNames  list( \link{PersonalNameGenderedOut} ) [optional]
#'
#'
  ...
  public = list(
    ...
    fromJSON = function(BatchPersonalNameGenderedOutJson) {
      ...
      if (!is.null(BatchPersonalNameGenderedOutObject$`personalNames`)) {
        self$`personalNames` <- ApiClient$new()$deserializeObj(BatchPersonalNameGenderedOutObject$`personalNames`, "array[PersonalNameGenderedOut]", loadNamespace("namsor"))
      }
    },

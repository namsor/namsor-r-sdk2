...
#' @docType class
#' @title BatchFirstLastNameGeoIn
#' @description BatchFirstLastNameGeoIn Class
#' @format An \code{R6Class} generator object
#' @field personalNames  list( \link{FirstLastNameGeoIn} ) [optional]
#'
#'
  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`personalNames`)) {
        BatchFirstLastNameGeoInObject[['personalNames']] <-
    ...
    fromJSON = function(BatchFirstLastNameGeoInJson) {
      ...
      if (!is.null(BatchFirstLastNameGeoInObject$`personalNames`)) {
        self$`personalNames` <- ApiClient$new()$deserializeObj(BatchFirstLastNameGeoInObject$`personalNames`, "array[FirstLastNameGeoIn]", loadNamespace("namsor"))
      }
    },

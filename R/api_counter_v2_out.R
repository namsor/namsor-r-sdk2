...
#' @field apiKey   \link[namsor:APIKeyOut]{  APIKeyOut  }  [optional]
#'
  ...
  public = list(
    ...
    fromJSON = function(APICounterV2OutJson) {
      ...
      if (!is.null(APICounterV2OutObject$`serviceFeaturesUsage`)) {
        self$`serviceFeaturesUsage` <- ApiClient$new()$deserializeObj(APICounterV2OutObject$`serviceFeaturesUsage`, "map(integer)", "package:namsor")
      }
    },

  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`matchedNames`)) {
        BatchNameMatchedOutObject[['matchedNames']] <-
          sapply(self$`matchedNames`, function(x) x$toJSON())
      }
    ...
    toJSONString = function() {
      jsoncontent <- c(
        ...
        [%s]
',
        paste(unlist(lapply(self$`matchedNames`, function(x) jsonlite::toJSON(x$toJSON(), auto_unbox=TRUE, digits = NA))), collapse=",")
        )}
      )

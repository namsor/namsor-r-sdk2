...
#'
#' @field aiVettedExpectedClassMetrics   \link[namsor:ExpectedClassMetricsOut]{   list(ExpectedClassMetricsOut)   }  [optional]
#'
#' @field aiNonVettedExpectedClassMetrics   \link[namsor:ExpectedClassMetricsOut]{   list(ExpectedClassMetricsOut)   }  [optional]
#'
#'
  ...
  public = list(
    ...
    fromJSON = function(ClassifierMetricsOutJson) {
      ...
      if (!is.null(ClassifierMetricsOutObject$`aiVettedExpectedClassMetrics`)) {
        self$`aiVettedExpectedClassMetrics` <- ApiClient$new()$deserializeObj(ClassifierMetricsOutObject$`aiVettedExpectedClassMetrics`, "array[ExpectedClassMetricsOut]", "package:namsor")
      }
      if (!is.null(ClassifierMetricsOutObject$`aiNonVettedExpectedClassMetrics`)) {
        self$`aiNonVettedExpectedClassMetrics` <- ApiClient$new()$deserializeObj(ClassifierMetricsOutObject$`aiNonVettedExpectedClassMetrics`, "array[ExpectedClassMetricsOut]", "package:namsor")
      }
    },
    toJSONString = function() {
      jsoncontent <- c(
        ...
        [%s]
',
        paste(unlist(lapply(self$`aiVettedExpectedClassMetrics`, function(x) jsonlite::toJSON(x$toJSON(), auto_unbox=TRUE, digits = NA))), collapse=",")
        )},
        if (!is.null(self$`aiNonVettedExpectedClassMetrics`)) {
        sprintf(
        ...
        [%s]
',
        paste(unlist(lapply(self$`aiNonVettedExpectedClassMetrics`, function(x) jsonlite::toJSON(x$toJSON(), auto_unbox=TRUE, digits = NA))), collapse=",")
        )}
      )

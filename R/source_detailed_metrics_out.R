...
#'
#' @field source   \link[namsor:APIKeyOut]{  APIKeyOut  }  [optional]
#'
...
#'
#' @field expectedClassMetrics   \link[namsor:ExpectedClassMetricsOut]{   list(ExpectedClassMetricsOut)   }  [optional]
#'
#'
  ...
  public = list(
    ...
    fromJSON = function(SourceDetailedMetricsOutJson) {
      ...
      if (!is.null(SourceDetailedMetricsOutObject$`expectedClassMetrics`)) {
        self$`expectedClassMetrics` <- ApiClient$new()$deserializeObj(SourceDetailedMetricsOutObject$`expectedClassMetrics`, "array[ExpectedClassMetricsOut]", "package:namsor")
      }
    },
    toJSONString = function() {
      jsoncontent <- c(
        ...
        [%s]
',
        paste(unlist(lapply(self$`expectedClassMetrics`, function(x) jsonlite::toJSON(x$toJSON(), auto_unbox=TRUE, digits = NA))), collapse=",")
        )}
      )

...
#' @field personalNames  list( \link{PersonalNameGeoIn} ) [optional]
#'
#'
  ...
  public = list(
    ...
    fromJSON = function(BatchPersonalNameGeoInJson) {
      ...
      if (!is.null(BatchPersonalNameGeoInObject$`personalNames`)) {
        self$`personalNames` <- ApiClient$new()$deserializeObj(BatchPersonalNameGeoInObject$`personalNames`, "array[PersonalNameGeoIn]", loadNamespace("namsor"))
      }
    },

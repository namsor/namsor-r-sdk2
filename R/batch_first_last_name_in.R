...
#' @docType class
#' @title BatchFirstLastNameIn
#' @description BatchFirstLastNameIn Class
#' @format An \code{R6Class} generator object
#' @field personalNames  list( \link{FirstLastNameIn} ) [optional]
#'
#'
  ...
  public = list(
    ...
    fromJSON = function(BatchFirstLastNameInJson) {
      ...
      if (!is.null(BatchFirstLastNameInObject$`personalNames`)) {
        self$`personalNames` <- ApiClient$new()$deserializeObj(BatchFirstLastNameInObject$`personalNames`, "array[FirstLastNameIn]", loadNamespace("namsor"))
      }
    },

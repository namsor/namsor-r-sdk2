...
#' @section Methods:
#' \describe{
#' \strong{ Country } \emph{ [USES 10 UNITS PER NAME] Infer the likely country of residence of a personal full name, or one surname. Assumes names as they are in the country of residence OR the country of origin. }
#' 
#'
#' \itemize{
#' \item \emph{ @param } personal.name.full character
#' \item \emph{ @returnType } \link{PersonalNameGeoOut} \cr
#'
#'
...
#' }
#'
#' \strong{ CountryBatch } \emph{ [USES 10 UNITS PER NAME] Infer the likely country of residence of up to 100 personal full names, or surnames. Assumes names as they are in the country of residence OR the country of origin. }
#' 
#'
#' \itemize{
#' \item \emph{ @param } batch.personal.name.in \link{BatchPersonalNameIn}
#' \item \emph{ @returnType } \link{BatchPersonalNameGeoOut} \cr
#'
#'
...
#' }
#'
#' \strong{ Diaspora } \emph{ [USES 20 UNITS PER NAME] Infer the likely ethnicity/diaspora of a personal name, given a country of residence ISO2 code (ex. US, CA, AU, NZ etc.) }
#' 
#'
#' \itemize{
...
#' \item \emph{ @returnType } \link{FirstLastNameDiasporaedOut} \cr
#'
#'
...
#' }
#'
#' \strong{ DiasporaBatch } \emph{ [USES 20 UNITS PER NAME] Infer the likely ethnicity/diaspora of up to 100 personal names, given a country of residence ISO2 code (ex. US, CA, AU, NZ etc.) }
#' 
#'
#' \itemize{
#' \item \emph{ @param } batch.first.last.name.geo.in \link{BatchFirstLastNameGeoIn}
#' \item \emph{ @returnType } \link{BatchFirstLastNameDiasporaedOut} \cr
#'
#'
...
#'
#' \itemize{
#' \item \emph{ @param } batch.personal.name.geo.in \link{BatchPersonalNameGeoIn}
#' \item \emph{ @returnType } \link{BatchPersonalNameGenderedOut} \cr
#'
#'
#' \item status code : 200 | A list of genderized names.
...
#' }
#'
#' \strong{ Origin } \emph{ [USES 10 UNITS PER NAME] Infer the likely country of origin of a personal name. Assumes names as they are in the country of origin. For US, CA, AU, NZ and other melting-pots : use &#39;diaspora&#39; instead. }
#' 
#'
#' \itemize{
#' \item \emph{ @param } first.name character
#' \item \emph{ @param } last.name character
#' \item \emph{ @returnType } \link{FirstLastNameOriginedOut} \cr
#'
#'
#' \item status code : 200 | A origined name.
#'
...
#' }
#'
#' \strong{ OriginBatch } \emph{ [USES 10 UNITS PER NAME] Infer the likely country of origin of up to 100 names, detecting automatically the cultural context. }
#' 
#'
#' \itemize{
#' \item \emph{ @param } batch.first.last.name.in \link{BatchFirstLastNameIn}
#' \item \emph{ @returnType } \link{BatchFirstLastNameOriginedOut} \cr
#'
#'
#' \item status code : 200 | A list of genderized names.
#'
...
#'
#' \itemize{
#' \item \emph{ @param } batch.parsed.full.name.in \link{BatchParsedFullNameIn}
#' \item \emph{ @returnType } \link{BatchFirstLastNameGenderedOut} \cr
#'
#'
#' \item status code : 200 | A list of genderized names.
...
#'
#' \itemize{
#' \item \emph{ @param } batch.parsed.full.name.geo.in \link{BatchParsedFullNameGeoIn}
#' \item \emph{ @returnType } \link{BatchFirstLastNameGenderedOut} \cr
#'
#'
#' \item status code : 200 | A list of genderized names.
...
#' }
#'
#' \strong{ UsRaceEthnicity } \emph{ [USES 10 UNITS PER NAME] Infer a US resident&#39;s likely race/ethnicity according to US Census taxonomy W_NL (white, non latino), HL (hispano latino),  A (asian, non latino), B_NL (black, non latino). }
#' 
#'
#' \itemize{
#' \item \emph{ @param } first.name character
#' \item \emph{ @param } last.name character
#' \item \emph{ @returnType } \link{FirstLastNameUSRaceEthnicityOut} \cr
#'
#'
...
#' }
#'
#' \strong{ UsRaceEthnicityBatch } \emph{ [USES 10 UNITS PER NAME] Infer up-to 100 US resident&#39;s likely race/ethnicity according to US Census taxonomy. }
#' 
#'
#' \itemize{
#' \item \emph{ @param } batch.first.last.name.geo.in \link{BatchFirstLastNameGeoIn}
#' \item \emph{ @returnType } \link{BatchFirstLastNameUSRaceEthnicityOut} \cr
#'
#'
...
#' }
#'
#' \strong{ UsRaceEthnicityZIP5 } \emph{ [USES 10 UNITS PER NAME] Infer a US resident&#39;s likely race/ethnicity according to US Census taxonomy, using (optional) ZIP5 code info. Output is W_NL (white, non latino), HL (hispano latino),  A (asian, non latino), B_NL (black, non latino). }
#' 
#'
#' \itemize{
#' \item \emph{ @param } first.name character
...
#' }
#'
#' \strong{ UsZipRaceEthnicityBatch } \emph{ [USES 10 UNITS PER NAME] Infer up-to 100 US resident&#39;s likely race/ethnicity according to US Census taxonomy, with (optional) ZIP code. }
#' 
#'
#' \itemize{
#' \item \emph{ @param } batch.first.last.name.geo.zipped.in \link{BatchFirstLastNameGeoZippedIn}
#' \item \emph{ @returnType } \link{BatchFirstLastNameUSRaceEthnicityOut} \cr
#'
#'
#' \item status code : 200 | A list of US resident&#39;s likely race/ethnicity. W_NL (white, non latino), HL (hispano latino),  A (asian, non latino), B_NL (black, non latino).
...
PersonalApi <- R6::R6Class(
  ...
  public = list(
    ...
    CountryWithHttpInfo = function(personal.name.full, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "PersonalNameGeoOut", loadNamespace("namsor")),
          error = function(e){
    ...
    CountryBatchWithHttpInfo = function(batch.personal.name.in=NULL, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "BatchPersonalNameGeoOut", loadNamespace("namsor")),
          error = function(e){
             stop("Failed to deserialize response")
          }
        )
    ...
    DiasporaWithHttpInfo = function(country.iso2, first.name, last.name, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "FirstLastNameDiasporaedOut", loadNamespace("namsor")),
          error = function(e){
             stop("Failed to deserialize response")
          }
        )
    ...
    DiasporaBatchWithHttpInfo = function(batch.first.last.name.geo.in=NULL, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "BatchFirstLastNameDiasporaedOut", loadNamespace("namsor")),
          error = function(e){
             stop("Failed to deserialize response")
          }
        )
    ...
    OriginWithHttpInfo = function(first.name, last.name, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "FirstLastNameOriginedOut", loadNamespace("namsor")),
          error = function(e){
             stop("Failed to deserialize response")
          }
        )
    ...
    OriginBatchWithHttpInfo = function(batch.first.last.name.in=NULL, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "BatchFirstLastNameOriginedOut", loadNamespace("namsor")),
          error = function(e){
             stop("Failed to deserialize response")
          }
        )
    ...
    UsRaceEthnicityWithHttpInfo = function(first.name, last.name, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "FirstLastNameUSRaceEthnicityOut", loadNamespace("namsor")),
          error = function(e){
             stop("Failed to deserialize response")
          }
        )
    ...
    UsRaceEthnicityBatchWithHttpInfo = function(batch.first.last.name.geo.in=NULL, ...){
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        deserializedRespObj <- tryCatch(
          self$apiClient$deserialize(resp, "BatchFirstLastNameUSRaceEthnicityOut", loadNamespace("namsor")),
          error = function(e){
             stop("Failed to deserialize response")
          }
        )

...
#' @field personalNamesWithPhoneNumbers  list( \link{FirstLastNamePhoneNumberIn} ) [optional]
#'
#'
  ...
  public = list(
    ...
    fromJSON = function(BatchFirstLastNamePhoneNumberInJson) {
      ...
      if (!is.null(BatchFirstLastNamePhoneNumberInObject$`personalNamesWithPhoneNumbers`)) {
        self$`personalNamesWithPhoneNumbers` <- ApiClient$new()$deserializeObj(BatchFirstLastNamePhoneNumberInObject$`personalNamesWithPhoneNumbers`, "array[FirstLastNamePhoneNumberIn]", loadNamespace("namsor"))
      }
    },

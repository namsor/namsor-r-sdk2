...
test_that("expectedClassMetrics", {
  # tests for the property `expectedClassMetrics` (ExpectedClassMetricsOut)

  # uncomment below to test the property 
  #expect_equal(model.instance$`expectedClassMetrics`, "EXPECTED_RESULT")
})
